...
La integración funciona **igual con solo `quipu-lite`**; si además instalas `elpandape/quipu-pro`, la capa lo
...
- PHP **8.4+**
- Laravel **12 o 13** (el motor tributario de Pro requiere Laravel 13+)
...
- **[Multi-tenant](/integraciones/laravel/multi-tenant)** <Availability pro /> — emitir para muchos emisores con
